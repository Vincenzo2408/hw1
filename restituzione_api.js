...
function caricapreferiti(){
    rest_url="carica_musica_libro.php";
...
function aggiungi_database_musica(event){
        ...
        fetch("musica_add.php?titolo=" +titolo).then(caricapreferiti);
}
...
function aggiungi_database_libro(event){
        ...
        fetch("libro_add.php?titolo=" +titolo_value).then(caricapreferiti);
}
...
function ricercamusica (event){
    ...
    fetch("cerca_da_api_spotify.php?cerca="+cerca).then(onResponse).then(onJson);
...
function ricercalibri (event){
    ...
    fetch("cerca_da_api_libro.php?cerca="+cerca).then(onResponse).then(onJson2);
	event.preventDefault();
}
